...
This README reads like a how-to guide from bottom up, so skip to "Installing Google Tag Manager >>"#installing-google-tag-manager for details on a recommended reference implementation for Google Tag Manager & Analytics.
